...
const Cart = () => {
    ...
    return (
        <div className='w-4/5 mx-auto'>
            ...
            {
                data.length === 0 ? <NoProduct /> : <div className=' p-2 lg:w-4/5 mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 '>
                    {
                        data.map((item, index) => (
                                ...
                                <div className="card  bg-base-100 shadow-xl">
                                    <div className="p-10 flex justify-between items-center">
                                        <div className='space-y-4'>
                                            ...
                                            <p className="text-xl font-semibold">Total Price: <span className="p-1 px-4 bg-yellow-200 rounded-full">{item.price1}$</span> </p>
